...
const BackOfficeMenuView = ({
  ...
  <Container>
    ...
    <InputContainer>
      <input type="date" value={getter[0]} onChange={(e) => setter[0](e.target.value)} />
      <InputView>
        <InputBox>
          <InputTitleWrapper>
            <SvgButton onClick={() => handleModal('S')}>
              <SvgIcon name="history" width={20} height={20} fill={EColor.TEXT_500} />
            </SvgButton>
    ...
    <ButtonView>
      <IconButton label="식단표 업로드" width={'132px'} height={'50px'} onClick={handleUploadMenu} />
      <IconButton label="엑셀파일 추출하기" width={'152px'} height={'50px'} onClick={handleExcelWeekMenu} />
    </ButtonView>
  </Container>
);

export default BackOfficeMenuView;
